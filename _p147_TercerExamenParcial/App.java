...
public class App extends JFrame implements ActionListener {
    ...
    public App(){
        ...
        lblDatos = new JLabel("Arriba la Maquina Celeste",JLabel.CENTER);
            ...
            if (e.getSource() == smnSalir) {
                ...
                if (res == JFileChooser.APPROVE_OPTION) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(this, "Error al procesar elarchivo", "Error",JOptionPane.ERROR_MESSAGE);
                }
            }
